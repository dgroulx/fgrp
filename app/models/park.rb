class Park < ActiveRecord::Base
  attr_accessible :address, :contact_info, :flickr_pool, :history, :latitude, :longitude, :name, :park_size, :vimeo_embed, :amenity_ids, :slug, :links_attributes, :park_amenities_attributes
